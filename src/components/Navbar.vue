<template>
    <div>
        <nav class="flex items-center justify-between flex-wrap bg-[#3fb86a] p-6">
  ...
  <div class="w-full block  lg:flex  lg:w-auto">
    <div class="text-sm lg:flex-grow">
        ...
        <router-link class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4" to="/product">Products</router-link>
      
      <router-link class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4" to="/user">Users</router-link>
    </div>
    <div>
